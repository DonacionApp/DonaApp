...
import { GEMINI_API_KEY } from 'src/config/constants';
...
export class IaService {
    ...
    async getTagsFromImages(files: Express.Multer.File[]): Promise<string[]> {
        try {
      ...
      `;
            ...
            // Lanzamos un error más genérico para el cliente
